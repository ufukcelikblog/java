...
public class Batak_02_1 implements ActionListener {
  ...
  private JLabel[] etkEller = new JLabel[4];
  private JLabel[] etkPuanlar = new JLabel[4];
  ...
  public void guiBaslat() {
    ...
    // oyuncuların adları için etiketleri oluşturma
    ...
    etkAdlar[0].setBounds(400, 470, 100, 30);
    etkAdlar[1].setBounds(30, 40, 100, 30);
    etkAdlar[2].setBounds(370, 10, 100, 30);
    etkAdlar[3].setBounds(870, 40, 100, 30);
    ...
    // oyuncuların bahisleri için etiketleri oluşturma
    for (int no = 0; no < etkBahisler.length; no++) {
      etkBahisler[no] = new JLabel("Bahis = " + oyuncular[no].getBahisSayisi());
      etkBahisler[no].setFont(new Font("Arial", Font.BOLD, 18));
    }
    etkBahisler[0].setBounds(450, 470, 100, 30);
    etkBahisler[1].setBounds(30, 70, 100, 30);
    etkBahisler[2].setBounds(500, 10, 1000, 30);
    etkBahisler[3].setBounds(800, 70, 100, 30);
    // bilgi etiketlerini çerçeveye ekleme
    ...
    // oyuncuların kazandığı eller için etiketleri oluşturma
    for (int no = 0; no < etkEller.length; no++) {
      etkEller[no] = new JLabel("Alınan El = "+oyuncular[no].getAlinanEl());
      etkEller[no].setFont(new Font("Arial", Font.BOLD, 18));
    }
    etkEller[0].setBounds(550, 470, 100, 30);
    etkEller[1].setBounds(30, 100, 100, 30);
    etkEller[2].setBounds(550, 10, 1000, 30);
    etkEller[3].setBounds(870, 100, 100, 30);
    // bilgi etiketlerini çerçeveye ekleme
    crv.add(etkEller[0]);
    crv.add(etkEller[1]);
    crv.add(etkEller[2]);
    ...
    // oyuncuların puanları için etiketleri oluşturma
    for (int no = 0; no < etkEller.length; no++) {
      etkPuanlar[no] = new JLabel("Alınan El = "+oyuncular[no].getAlinanEl());
      etkPuanlar[no].setFont(new Font("Arial", Font.BOLD, 18));
    }
    etkPuanlar[0].setBounds(550, 470, 100, 30);
    etkPuanlar[1].setBounds(30, 100, 100, 30);
    etkPuanlar[2].setBounds(550, 10, 1000, 30);
    etkPuanlar[3].setBounds(870, 100, 100, 30);
    // bilgi etiketlerini çerçeveye ekleme
    crv.add(etkPuanlar[0]);
    crv.add(etkPuanlar[1]);
    crv.add(etkPuanlar[2]);
    crv.add(etkPuanlar[3]);    
